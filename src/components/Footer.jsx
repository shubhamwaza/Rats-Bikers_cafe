...
export default function Footer({ setActiveTab, onOpenBooking, onOpenMembership }) {
  return (
    <footer className="bg-[#07080B] border-t border-white/10 pt-16 pb-12 text-slate-400 relative overflow-hidden">
      {/* Glow highlight */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-96 h-48 bg-[#FF5500]/10 blur-3xl pointer-events-none rounded-full"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-white/10">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-[#FF5500] flex items-center justify-center orange-glow-sm">
                <Bike className="w-6 h-6 text-white" />
              </div>
              <div>
                <h3 className="font-extrabold text-xl text-white tracking-wider">R.A.T.S</h3>
                <p className="text-[10px] text-slate-400 uppercase tracking-widest">Riding & Touring Squad</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 pt-2">
              <a 
                ...
                target="_blank" 
                rel="noreferrer"
                className="w-9 h-9 rounded-lg bg-slate-900 border border-white/10 flex items-center justify-center text-slate-300 hover:text-[#FF5500] hover:border-[#FF5500]/50 transition-colors"
                title="Facebook"
              >
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2.5 text-xs">
              <li>
                <button onClick={() => setActiveTab('home')} className="hover:text-[#FF5500] transition-colors flex items-center gap-1.5">
                  <ArrowUpRight className="w-3.5 h-3.5 opacity-60" /> Home Overview
                </button>
              </li>
              <li>
                <button onClick={() => setActiveTab('cafe')} className="hover:text-[#FF5500] transition-colors flex items-center gap-1.5">
                  <ArrowUpRight className="w-3.5 h-3.5 opacity-60" /> R.A.T.S Bikers Cafe Menu
                </button>
              </li>
              <li>
                <button onClick={onOpenBooking} className="hover:text-[#FF5500] transition-colors flex items-center gap-1.5 font-semibold text-[#FF5500]">
              ...
              <li>
                <button onClick={() => setActiveTab('rides')} className="hover:text-[#FF5500] transition-colors flex items-center gap-1.5">
                  <ArrowUpRight className="w-3.5 h-3.5 opacity-60" /> Upcoming Cafe Rides Calendar
                </button>
              </li>
              <li>
                <button onClick={() => setActiveTab('store')} className="hover:text-[#FF5500] transition-colors flex items-center gap-1.5">
          ...
          {/* Operating Hours */}
          <div className="space-y-4">
            <h4 className="font-bold text-sm text-white uppercase tracking-wider">Operating Timings</h4>
            <div className="bg-slate-900/80 p-4 rounded-xl border border-white/10 space-y-2.5 text-xs">
              ...
              <div className="flex justify-between items-center pb-2 border-b border-white/10">
                ...
                <span className="font-semibold text-[#FF5500]">05:00 AM - Midnight</span>
              </div>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500 gap-4">
          ...
          <div className="flex items-center gap-4">
            <span className="flex items-center gap-1 text-slate-400">
              Built for Bikers with <Heart className="w-3.5 h-3.5 text-[#FF5500] fill-[#FF5500]" />
            </span>
          </div>
        </div>
